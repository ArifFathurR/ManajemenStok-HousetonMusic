                            ...
                            <div className="space-y-1.5 z-10">
                                ...
                                <Select
                                    ...
                                    value={[
                                        ...
                                        { value: 'debit', label: 'Debit Card' },
                                        { value: 'qr', label: 'QRIS' }
                                    ].find(opt => opt.value === filterValues.payment_method)}
                                    onChange={(option) => handleFilter('payment_method', option.value)}
                                    styles={{
                                        control: (base, state) => ({
                                            ...base,
                                            borderRadius: '0.75rem',
                            ...
                            <div className="col-span-1 md:col-span-2 space-y-1.5">
                                ...
                                <div className="flex flex-col sm:flex-row gap-2">
                                    ...
                                    <div className="flex items-center gap-2 flex-1 w-full">
                                        ...
                                        <input type="date" value={filterValues.end_date} onChange={(e) => handleFilter('end_date', e.target.value)} className="w-full border-gray-200 rounded-xl text-xs font-medium focus:border-gray-300 focus:ring-0 py-2.5 bg-gray-50/50" />
