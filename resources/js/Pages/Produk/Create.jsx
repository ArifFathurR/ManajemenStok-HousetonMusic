...
const MASTER_WARNA = [
    { id: 1, label: 'Merah', hex: '#EF4444' },
    { id: 2, label: 'Biru', hex: '#3B82F6' },
    { id: 3, label: 'Hijau', hex: '#10B981' },
    { id: 4, label: 'Hitam', hex: '#000000' },
    { id: 5, label: 'Putih', hex: '#FFFFFF' },
    { id: 6, label: 'Kuning', hex: '#F59E0B' },
];
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex flex-wrap gap-2 mb-4">
                                                        {MASTER_WARNA.map(w => (
                                                            ...
                                                            >
                                                                <span className="w-3 h-3 rounded-full border border-gray-100" style={{ backgroundColor: w.hex }}></span>
                                                                {w.label}
                                                            </button>
                                                        ))}
                                                    </div>
